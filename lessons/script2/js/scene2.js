...
class scene2 extends Phaser.Scene{
	...
	create(){
		...
		var loop_char = 10;
		var chars = [];
		var x_char = screen.x/2 - 15, y_char = screen.y - 40;
		...
		this.input.keyboard.on('keydown', function (event) {
			...
			if (event.key.toUpperCase() == current_key) {
				...
				chars[current_index] = (this.add.text(chars[current_index].x, chars[current_index].y, current_key.toLowerCase(), {fontSize:100, fontFamily: 'Arial', color:'red'}).setOrigin(0.5));
